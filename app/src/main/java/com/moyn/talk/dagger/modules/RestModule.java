 ...
 */
package com.moyn.talk.dagger.modules;
...
public class RestModule {
    ...
    @Singleton
    @Provides
    SSLSocketFactoryCompat provideSslSocketFactoryCompat(MagicKeyManager keyManager,
    ...
    OkHttpClient provideHttpClient(Proxy proxy, AppPreferences appPreferences,
        ...
        if (BuildConfig.DEBUG && !context.getResources().getBoolean(R.bool.nc_is_debug)) {
            ...
            HttpLoggingInterceptor.Logger fileLogger = s -> LoggingUtils.INSTANCE.writeLogEntryToFile(context, s);
