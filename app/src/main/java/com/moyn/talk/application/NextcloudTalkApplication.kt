 ...
 */
package com.moyn.talk.application
...
import com.moyn.talk.dagger.modules.BusModule
import com.moyn.talk.dagger.modules.ContextModule
import com.moyn.talk.dagger.modules.DatabaseModule
import com.moyn.talk.dagger.modules.RestModule
...
import com.moyn.talk.utils.DeviceUtils
import com.moyn.talk.utils.DisplayUtils
import com.moyn.talk.utils.NotificationUtils
import com.moyn.talk.utils.OkHttpNetworkFetcherWithCache
import com.moyn.talk.utils.database.arbitrarystorage.ArbitraryStorageModule
import com.moyn.talk.utils.database.user.UserModule
...
class NextcloudTalkApplication : MultiDexApplication(), LifecycleObserver {
    ...
    override fun onCreate() {
        ...
        CloseInterfaceImpl().providerInstallerInstallIfNeededAsync()
