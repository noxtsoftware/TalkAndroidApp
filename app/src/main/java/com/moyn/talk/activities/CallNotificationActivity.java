...
import com.moyn.talk.databinding.CallNotificationActivityBinding;
...
public class CallNotificationActivity extends CallBaseActivity {
    ...
    private void setCallDescriptionText() {
        String callDescriptionWithoutTypeInfo = String.format(
        ...
        ncApi.getRoom(credentials, ApiUtils.getUrlForRoom(apiVersion, userBeingCalled.getBaseUrl(), roomId))
                ...
                .subscribe(new Observer<RoomOverall>() {
                    ...
                    public void onNext(@io.reactivex.annotations.NonNull RoomOverall roomOverall) {
                        ...
                        if (apiVersion >= 3) {
                            boolean hasCallFlags = CapabilitiesUtil.hasSpreedFeatureCapability(userBeingCalled,
