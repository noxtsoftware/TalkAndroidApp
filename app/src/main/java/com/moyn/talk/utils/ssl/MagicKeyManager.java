...
public class MagicKeyManager implements X509KeyManager {
    ...
    public String chooseClientAlias(String[] strings, Principal[] principals, Socket socket) {
        ...
        if ((userUtils.getCurrentUser() != null
                && !TextUtils.isEmpty(alias = userUtils.getCurrentUser().getClientCertificate())) ||
    ...
    private X509Certificate[] getCertificatesForAlias(@Nullable String alias) {
        if (alias != null) {
            GetCertificatesForAliasRunnable getCertificatesForAliasRunnable = new GetCertificatesForAliasRunnable(
                    alias);
