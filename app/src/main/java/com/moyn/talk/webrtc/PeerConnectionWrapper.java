...
public class PeerConnectionWrapper {
    ...
    public PeerConnectionWrapper(PeerConnectionFactory peerConnectionFactory,
        ...
        Objects.requireNonNull(NextcloudTalkApplication.Companion.getSharedApplication()).getComponentApplication()
                .inject(this);
    ...
    public String getNick() {
        if (!TextUtils.isEmpty(nick)) {
            ...
            return Objects.requireNonNull(NextcloudTalkApplication.Companion.getSharedApplication())
                        ...
                        if (!internalNick.equals(nick)) {
                            ...
                            EventBus.getDefault()
                                    .post(new PeerConnectionEvent(
                                            PeerConnectionEvent.PeerConnectionEventType.NICK_CHANGE, sessionId,
                                            getNick(), null, videoStreamType));
                        }
                    } else {
                        if (dataChannelMessage.getPayload() != null) {
                            HashMap<String, String> payloadHashMap = (HashMap<String, String>) dataChannelMessage
                                    .getPayload();
                            EventBus.getDefault()
                                    .post(new PeerConnectionEvent(
                                            PeerConnectionEvent.PeerConnectionEventType.NICK_CHANGE, sessionId,
                                            payloadHashMap.get("name"), null, videoStreamType));
                        }
                    }
                } else if ("audioOn".equals(dataChannelMessage.getType())) {
                    EventBus.getDefault()
                            .post(new PeerConnectionEvent(PeerConnectionEvent.PeerConnectionEventType.AUDIO_CHANGE,
                                    sessionId, null, TRUE, videoStreamType));
                } else if ("audioOff".equals(dataChannelMessage.getType())) {
                    EventBus.getDefault()
                            .post(new PeerConnectionEvent(PeerConnectionEvent.PeerConnectionEventType.AUDIO_CHANGE,
                                    sessionId, null, FALSE, videoStreamType));
                } else if ("videoOn".equals(dataChannelMessage.getType())) {
                    EventBus.getDefault()
                            .post(new PeerConnectionEvent(PeerConnectionEvent.PeerConnectionEventType.VIDEO_CHANGE,
                                    sessionId, null, TRUE, videoStreamType));
    ...
    private class MagicPeerConnectionObserver implements PeerConnection.Observer {
        ...
        public void onIceConnectionChange(PeerConnection.IceConnectionState iceConnectionState) {
            ...
            if (iceConnectionState.equals(PeerConnection.IceConnectionState.CONNECTED)) {
                ...
                EventBus.getDefault()
                        .post(new PeerConnectionEvent(PeerConnectionEvent.PeerConnectionEventType.PEER_CLOSED,
                ...
                if (isMCUPublisher) {
                    EventBus.getDefault().post(new PeerConnectionEvent(
                            PeerConnectionEvent.PeerConnectionEventType.PUBLISHER_FAILED, sessionId, null, null, null));
                }
            }
        }
        ...
        public void onSetSuccess() {
            if (peerConnection != null) {
                if (peerConnection.getLocalDescription() == null) {
                     ...
                     * See for details: https://docs.google.com/document/d/
                     * 1PPHWV6108znP1tk_rkCnyagH9FK205hHeE9k5mhUzOg/edit#heading=h.9dcmkavg608r
                     */
