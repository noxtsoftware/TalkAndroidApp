...
package com.moyn.talk.components.filebrowser.webdav;
...
public class DavUtils {
    ...
    public static void registerCustomFactories() {
        ...
        try {
            ...
            Map<Property.Name, PropertyFactory> reflectionMap = (HashMap<Property.Name, PropertyFactory>) factories
                    .get(propertyRegistry);
