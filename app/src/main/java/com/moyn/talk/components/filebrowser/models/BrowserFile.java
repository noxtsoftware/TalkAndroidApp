...
package com.moyn.talk.components.filebrowser.models;

import android.net.Uri;
import android.text.TextUtils;

import com.bluelinelabs.logansquare.annotation.JsonObject;
import com.moyn.talk.components.filebrowser.models.properties.NCEncrypted;
import com.moyn.talk.components.filebrowser.models.properties.NCPermission;
import com.moyn.talk.components.filebrowser.models.properties.NCPreview;
import com.moyn.talk.components.filebrowser.models.properties.OCFavorite;
import com.moyn.talk.components.filebrowser.models.properties.OCId;
import com.moyn.talk.components.filebrowser.models.properties.OCSize;
...
public class BrowserFile {
    ...
    public static BrowserFile getModelFromResponse(Response response, String remotePath) {
        ...
        for (Property property : properties) {
            ...
            if (property instanceof ResourceType) {
                browserFile.isFile = !(((ResourceType) property).getTypes()
    ...
    public String toString() {
        return "BrowserFile(path=" + this.getPath() + ", displayName=" + this.getDisplayName() + ", mimeType="
                + this.getMimeType() + ", modifiedTimestamp=" + this.getModifiedTimestamp() + ", size=" + this.getSize()
                + ", isFile=" + this.isFile() + ", remoteId=" + this.getRemoteId() + ", hasPreview="
                + this.isHasPreview() + ", favorite=" + this.isFavorite() + ", encrypted=" + this.isEncrypted()
                + ", permissions=" + this.getPermissions() + ", isAllowedToReShare=" + this.isAllowedToReShare() + ")";
    }
}
