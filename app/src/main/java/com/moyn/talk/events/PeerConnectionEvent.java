...
public class PeerConnectionEvent {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$peerConnectionEventType == null ? other$peerConnectionEventType != null
                : !this$peerConnectionEventType.equals(other$peerConnectionEventType)) {
            return false;
        }
    ...
    public String toString() {
        return "PeerConnectionEvent(peerConnectionEventType=" + this.getPeerConnectionEventType() + ", sessionId="
                + this.getSessionId() + ", nick=" + this.getNick() + ", changeValue=" + this.getChangeValue()
