...
public class SessionDescriptionSendEvent {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$sessionDescription == null ? other$sessionDescription != null
                : !this$sessionDescription.equals(other$sessionDescription)) {
            return false;
        }
        ...
        if (this$ncIceCandidate == null ? other$ncIceCandidate != null
                : !this$ncIceCandidate.equals(other$ncIceCandidate)) {
            return false;
        }
        final Object this$videoStreamType = this.getVideoStreamType();
        final Object other$videoStreamType = other.getVideoStreamType();

        return this$videoStreamType == null ? other$videoStreamType == null
                : this$videoStreamType.equals(other$videoStreamType);
    }
    ...
    public String toString() {
        return "SessionDescriptionSendEvent(sessionDescription=" + this.getSessionDescription() + ", peerId="
                + this.getPeerId() + ", type=" + this.getType() + ", ncIceCandidate=" + this.getNcIceCandidate()
                + ", videoStreamType=" + this.getVideoStreamType() + ")";
    }
}
