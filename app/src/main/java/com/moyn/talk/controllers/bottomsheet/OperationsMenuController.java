...
import static com.moyn.talk.controllers.bottomsheet.ConversationOperationEnum.OPS_CODE_JOIN_ROOM;
import static com.moyn.talk.controllers.bottomsheet.ConversationOperationEnum.OPS_CODE_REMOVE_FAVORITE;
...
import com.moyn.talk.models.json.capabilities.Capabilities;
...
import com.moyn.talk.utils.NoSupportedApiException;
...
public class OperationsMenuController extends BaseController {
    ...
    public OperationsMenuController(Bundle args) {
        ...
        if (args.containsKey(BundleKeys.INSTANCE.getKEY_SERVER_CAPABILITIES())) {
            this.serverCapabilities = Parcels
                    .unwrap(args.getParcelable(BundleKeys.INSTANCE.getKEY_SERVER_CAPABILITIES()));
        }
    ...
    private void showResultImage(boolean everythingOK, boolean isGuestSupportError) {
        ...
        if (everythingOK) {
            ...
            resultImageView.setImageDrawable(DisplayUtils.getTintedDrawable(getResources(),
                    R.drawable.ic_cancel_black_24dp, R.color.nc_darkRed));
