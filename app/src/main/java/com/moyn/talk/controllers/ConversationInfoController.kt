...
import com.moyn.talk.controllers.bottomsheet.items.BasicListItemWithImage
import com.moyn.talk.controllers.bottomsheet.items.listItemsWithImage
import com.moyn.talk.controllers.util.viewBinding
import com.moyn.talk.databinding.ControllerConversationInfoBinding
...
import com.moyn.talk.models.json.converters.EnumNotificationLevelConverter
import com.moyn.talk.models.json.generic.GenericOverall
import com.moyn.talk.models.json.participants.Participant
import com.moyn.talk.models.json.participants.Participant.ActorType.CIRCLES
import com.moyn.talk.models.json.participants.Participant.ActorType.GROUPS
import com.moyn.talk.models.json.participants.Participant.ActorType.USERS
...
import com.moyn.talk.utils.preferences.preferencestorage.DatabaseStorageModule
    ...
    private fun loadConversationAvatar() {
        when (conversation!!.type) {
            ...
            Conversation.ConversationType.ROOM_SYSTEM -> {
                ...
                layers[0] = ContextCompat.getDrawable(context!!, R.drawable.launcher_background);
                layers[1] = ContextCompat.getDrawable(context!!, R.drawable.moyn_peace)
