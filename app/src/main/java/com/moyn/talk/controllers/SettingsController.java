...
import com.moyn.talk.utils.preferences.MagicUserInputModule;
    ...
    protected void onViewBound(@NonNull View view) {
        ...
        if (!TextUtils.isEmpty(getResources().getString(R.string.nc_source_code_url))) {
            sourceCodeButton.addPreferenceClickListener(view13 -> {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse(getResources().getString(R.string.nc_source_code_url)));
                startActivity(browserIntent);
            });
        } else {
    ...
    protected void onAttach(@NonNull View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationsCategory
                    .setTitle(getResources().getString(R.string.nc_settings_notification_sounds_post_oreo));
        }
