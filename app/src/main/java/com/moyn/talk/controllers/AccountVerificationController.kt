...
import com.moyn.talk.databinding.ControllerAccountVerificationBinding
import com.moyn.talk.events.EventStatus
import com.moyn.talk.jobs.CapabilitiesWorker
import com.moyn.talk.jobs.PushRegistrationWorker
import com.moyn.talk.jobs.SignalingSettingsWorker
...
import com.moyn.talk.utils.CloseInterfaceImpl
import com.moyn.talk.utils.UriUtils
import com.moyn.talk.utils.bundle.BundleKeys.KEY_BASE_URL
import com.moyn.talk.utils.bundle.BundleKeys.KEY_INTERNAL_USER_ID
import com.moyn.talk.utils.bundle.BundleKeys.KEY_IS_ACCOUNT_IMPORT
import com.moyn.talk.utils.bundle.BundleKeys.KEY_ORIGINAL_PROTOCOL
import com.moyn.talk.utils.bundle.BundleKeys.KEY_TOKEN
import com.moyn.talk.utils.bundle.BundleKeys.KEY_USERNAME
import com.moyn.talk.utils.database.user.UserUtils
import com.moyn.talk.utils.singletons.ApplicationWideMessageHolder
        ...
        userUtils.createOrUpdateUser(
            ...
            .subscribe(object : Observer<UserEntity> {
                ...
                override fun onNext(userEntity: UserEntity) {
                    ...
                    if (CloseInterfaceImpl().isGooglePlayServicesAvailable) {
                        registerForPush()
                    } else {
                        activity!!.runOnUiThread {
