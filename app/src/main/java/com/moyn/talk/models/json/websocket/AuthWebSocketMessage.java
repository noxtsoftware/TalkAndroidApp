...
public class AuthWebSocketMessage {
    ...
    public boolean equals(final Object o) {
        ...
        return this$authParametersWebSocketMessage == null ? other$authParametersWebSocketMessage == null
                : this$authParametersWebSocketMessage.equals(other$authParametersWebSocketMessage);
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME
                + ($authParametersWebSocketMessage == null ? 43 : $authParametersWebSocketMessage.hashCode());
        return result;
    }

    public String toString() {
        return "AuthWebSocketMessage(url=" + this.getUrl() + ", authParametersWebSocketMessage="
                + this.getAuthParametersWebSocketMessage() + ")";
    }
}
