...
public class RoomWebSocketMessage {
    ...
    public boolean equals(final Object o) {
        ...
        return this$roomPropertiesWebSocketMessage == null ? other$roomPropertiesWebSocketMessage == null
                : this$roomPropertiesWebSocketMessage.equals(other$roomPropertiesWebSocketMessage);
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME
                + ($roomPropertiesWebSocketMessage == null ? 43 : $roomPropertiesWebSocketMessage.hashCode());
        return result;
    }

    public String toString() {
        return "RoomWebSocketMessage(roomId=" + this.getRoomId() + ", sessiondId=" + this.getSessiondId()
                + ", roomPropertiesWebSocketMessage=" + this.getRoomPropertiesWebSocketMessage() + ")";
    }
}
