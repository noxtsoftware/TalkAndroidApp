...
package com.moyn.talk.models.json.generic;
...
public class Status {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$versionString == null ? other$versionString != null
    ...
    public String toString() {
        return "Status(installed=" + this.isInstalled() + ", maintenance=" + this.isMaintenance() + ", needsUpgrade="
                + this.isNeedsUpgrade() + ", version=" + this.getVersion() + ", versionString="
                + this.getVersionString() + ", edition=" + this.getEdition() + ", productName=" + this.getProductName()
                + ")";
    }
}
