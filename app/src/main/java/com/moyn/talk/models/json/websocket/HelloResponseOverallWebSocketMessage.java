...
public class HelloResponseOverallWebSocketMessage extends BaseWebSocketMessage {
    ...
    public boolean equals(final Object o) {
        ...
        return this$helloResponseWebSocketMessage == null ? other$helloResponseWebSocketMessage == null
                : this$helloResponseWebSocketMessage.equals(other$helloResponseWebSocketMessage);
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME
                + ($helloResponseWebSocketMessage == null ? 43 : $helloResponseWebSocketMessage.hashCode());
        return result;
    }

    public String toString() {
        return "HelloResponseOverallWebSocketMessage(helloResponseWebSocketMessage="
                + this.getHelloResponseWebSocketMessage() + ")";
    }
}
