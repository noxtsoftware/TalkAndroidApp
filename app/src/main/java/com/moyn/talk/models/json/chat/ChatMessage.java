 ...
 */
package com.moyn.talk.models.json.chat;
...
import com.moyn.talk.models.json.converters.EnumSystemMessageTypeConverter;
...
public class ChatMessage implements MessageContentType, MessageContentType.Image {
                    ...
                    if (!isVoiceMessage()) {
                        return (ApiUtils.getUrlForFilePreviewWithFileId(getActiveUser().getBaseUrl(),
                                individualHashMap.get("id"), NextcloudTalkApplication.Companion.getSharedApplication()
                                        .getResources().getDimensionPixelSize(R.dimen.maximum_file_preview_size)));
                    }
                }
            }
        }
    ...
    public String getLastMessageDisplayText() {
        if (getMessageType().equals(MessageType.REGULAR_TEXT_MESSAGE)
                || getMessageType().equals(MessageType.SYSTEM_MESSAGE)
                || getMessageType().equals(MessageType.SINGLE_LINK_MESSAGE)) {
            return getText();
        } else {
            if (MessageType.SINGLE_LINK_GIPHY_MESSAGE == getMessageType()
                ...
                if (getActorId().equals(getActiveUser().getUserId())) {
                    return (NextcloudTalkApplication.Companion.getSharedApplication()
                            .getString(R.string.nc_sent_location_you));
                } else {
                    return (String.format(
                            NextcloudTalkApplication.Companion.getSharedApplication().getResources()
                                    .getString(R.string.nc_sent_location),
                            !TextUtils.isEmpty(getActorDisplayName()) ? getActorDisplayName()
                                    : NextcloudTalkApplication.Companion.getSharedApplication()
                                            .getString(R.string.nc_guest)));
                }
                ...
                if (getActorId().equals(getActiveUser().getUserId())) {
                    return (NextcloudTalkApplication.Companion.getSharedApplication()
                            .getString(R.string.nc_sent_voice_you));
                } else {
                    return (String.format(
                            NextcloudTalkApplication.Companion.getSharedApplication().getResources()
                                    .getString(R.string.nc_sent_voice),
                            !TextUtils.isEmpty(getActorDisplayName()) ? getActorDisplayName()
                                    : NextcloudTalkApplication.Companion.getSharedApplication()
                                            .getString(R.string.nc_guest)));
                }
                 ...
                 * if (getActorId().equals(getActiveUser().getUserId())) {
                 * return
                 * (NextcloudTalkApplication.Companion.getSharedApplication().getString(R.string
                 * .nc_sent_a_link_you));
                 * } else {
                 * return
                 * (String.format(NextcloudTalkApplication.Companion.getSharedApplication().
                 * getResources().getString(R.string.nc_sent_a_link),
                 * !TextUtils.isEmpty(getActorDisplayName()) ? getActorDisplayName() :
                 * NextcloudTalkApplication.Companion.getSharedApplication().getString(R.string.
                 * nc_guest)));
                 * }
        ...
        return new IUser() {
            ...
            public String getAvatar() {
                if (getActorType().equals("users")) {
                    ...
                    String apiId = NextcloudTalkApplication.Companion.getSharedApplication()
                            .getString(R.string.nc_guest);
    ...
    public boolean equals(final Object o) {
        ...
        if (this$selectedIndividualHashMap == null ? other$selectedIndividualHashMap != null
                : !this$selectedIndividualHashMap.equals(other$selectedIndividualHashMap)) {
            return false;
        }
        ...
        if (this$actorDisplayName == null ? other$actorDisplayName != null
                : !this$actorDisplayName.equals(other$actorDisplayName)) {
            return false;
        }
        ...
        if (this$messageParameters == null ? other$messageParameters != null
                : !this$messageParameters.equals(other$messageParameters)) {
            return false;
        }
        ...
        if (this$systemMessageType == null ? other$systemMessageType != null
                : !this$systemMessageType.equals(other$systemMessageType)) {
            return false;
        }
        ...
        if (this$parentMessage == null ? other$parentMessage != null
                : !this$parentMessage.equals(other$parentMessage)) {
            return false;
        }
        ...
        return this$messageTypesToIgnore == null ? other$messageTypesToIgnore == null
                : this$messageTypesToIgnore.equals(other$messageTypesToIgnore);
    }
    ...
    public String toString() {
        return "ChatMessage(isGrouped=" + this.isGrouped() + ", isOneToOneConversation=" + this.isOneToOneConversation()
                + ", activeUser=" + this.getActiveUser() + ", selectedIndividualHashMap="
                + this.getSelectedIndividualHashMap() + ", isDeleted=" + this.isDeleted() + ", jsonMessageId="
                + this.getJsonMessageId() + ", token=" + this.getToken() + ", actorType=" + this.getActorType()
                + ", actorId=" + this.getActorId() + ", actorDisplayName=" + this.getActorDisplayName() + ", timestamp="
                + this.getTimestamp() + ", message=" + this.getMessage() + ", messageParameters="
                + this.getMessageParameters() + ", systemMessageType=" + this.getSystemMessageType() + ", replyable="
                + this.isReplyable() + ", parentMessage=" + this.getParentMessage() + ", readStatus="
