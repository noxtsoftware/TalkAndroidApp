...
public class RequestOfferOverallWebSocketMessage extends BaseWebSocketMessage {
    ...
    public void setRequestOfferOverallWebSocketMessage(
            RequestOfferSignalingMessage requestOfferOverallWebSocketMessage) {
    ...
    public boolean equals(final Object o) {
        ...
        return this$requestOfferOverallWebSocketMessage == null ? other$requestOfferOverallWebSocketMessage == null
                : this$requestOfferOverallWebSocketMessage.equals(other$requestOfferOverallWebSocketMessage);
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME
                + ($requestOfferOverallWebSocketMessage == null ? 43 : $requestOfferOverallWebSocketMessage.hashCode());
        return result;
    }

    public String toString() {
        return "RequestOfferOverallWebSocketMessage(requestOfferOverallWebSocketMessage="
                + this.getRequestOfferOverallWebSocketMessage() + ")";
    }
}
