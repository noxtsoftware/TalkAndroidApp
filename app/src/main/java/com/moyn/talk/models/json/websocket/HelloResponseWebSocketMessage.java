...
public class HelloResponseWebSocketMessage {
    ...
    public void setServerHelloResponseFeaturesWebSocketMessage(
            ServerHelloResponseFeaturesWebSocketMessage serverHelloResponseFeaturesWebSocketMessage) {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$serverHelloResponseFeaturesWebSocketMessage = this
                .getServerHelloResponseFeaturesWebSocketMessage();
        final Object other$serverHelloResponseFeaturesWebSocketMessage = other
                .getServerHelloResponseFeaturesWebSocketMessage();

        return this$serverHelloResponseFeaturesWebSocketMessage == null
                ? other$serverHelloResponseFeaturesWebSocketMessage == null
                : this$serverHelloResponseFeaturesWebSocketMessage
    ...
    public int hashCode() {
        ...
        final Object $serverHelloResponseFeaturesWebSocketMessage = this
                .getServerHelloResponseFeaturesWebSocketMessage();
        result = result * PRIME + ($serverHelloResponseFeaturesWebSocketMessage == null ? 43
                : $serverHelloResponseFeaturesWebSocketMessage.hashCode());
        return result;
    }

    public String toString() {
        return "HelloResponseWebSocketMessage(resumeId=" + this.getResumeId() + ", sessionId=" + this.getSessionId()
                + ", serverHelloResponseFeaturesWebSocketMessage="
