...
package com.moyn.talk.models.json.signaling.settings;
...
public class Settings {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$externalSignalingServer == null ? other$externalSignalingServer != null
                : !this$externalSignalingServer.equals(other$externalSignalingServer)) {
            return false;
        }
        ...
        return this$externalSignalingTicket == null ? other$externalSignalingTicket == null
                : this$externalSignalingTicket.equals(other$externalSignalingTicket);
    }
    ...
    public String toString() {
        return "Settings(stunServers=" + this.getStunServers() + ", turnServers=" + this.getTurnServers()
                + ", externalSignalingServer=" + this.getExternalSignalingServer() + ", externalSignalingTicket="
                + this.getExternalSignalingTicket() + ")";
    }
}
