...
public class NCMessageWrapper {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$signalingMessage == null ? other$signalingMessage != null
                : !this$signalingMessage.equals(other$signalingMessage)) {
            return false;
        }
    ...
    public String toString() {
        return "NCMessageWrapper(signalingMessage=" + this.getSignalingMessage() + ", ev=" + this.getEv()
