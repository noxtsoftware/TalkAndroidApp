...
import com.moyn.talk.models.json.push.PushRegistrationOverall;
...
import com.moyn.talk.models.json.status.StatusOverall;
import com.moyn.talk.models.json.statuses.StatusesOverall;
import com.moyn.talk.models.json.userprofile.UserProfileFieldsOverall;
...
public interface NcApi {
     ...
     * - "newParticipant" : "user"
     * 
     * Server URL is: baseUrl + ocsApiVersion + spreedApiVersion +
     * /room/roomToken/participants
     */
    @POST
    ...
    Observable<GenericOverall> removeAttendeeFromConversation(@Header("Authorization") String authorization,
            @Url String url, @Query("attendeeId") Long attendeeId);

    @Deprecated
    @POST
    Observable<GenericOverall> promoteUserToModerator(@Header("Authorization") String authorization, @Url String url,
            @Query("participant") String participantId);

    @Deprecated
    @DELETE
    Observable<GenericOverall> demoteModeratorToUser(@Header("Authorization") String authorization, @Url String url,
            @Query("participant") String participantId);
    ...
    /*
     * Server URL is: baseUrl + ocsApiVersion + spreedApiVersion +
     * /room/roomToken/participants/self
     */
    ...
    @FormUrlEncoded
    @POST
    Observable<RoomOverall> joinRoom(@Nullable @Header("Authorization") String authorization, @Url String url,
    ...
    @FormUrlEncoded
    @POST
    Observable<GenericOverall> setNotificationLevel(@Header("Authorization") String authorization, @Url String url,
            @Field("level") int level);

    @FormUrlEncoded
    @PUT
    Observable<GenericOverall> setReadOnlyState(@Header("Authorization") String authorization, @Url String url,
